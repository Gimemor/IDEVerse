...
namespace RBCAcademy.Controllers
{
    [Route("api/subjects")]
    [ApiController]
    public class SubjectsApiController : BaseApiContoller
	{
        private ISubjectService _subjectService;
        private UserManager _userManager;
        public SubjectsApiController(ISubjectService subjectService, UserManager userManager)
        {
        ...
        {
            return await CallAsync(async () => await _subjectService.GetSubjectsByUserId(_userManager.Id));
        }
